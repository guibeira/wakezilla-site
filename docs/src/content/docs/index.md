...
Wakezilla's dashboard and remote power endpoints do not provide authentication or TLS. Read [Security](./reference/security/) before allowing access from another host, and review [Known Limitations](./help/known-limitations/) before choosing custom ports or relying on status and inactivity behavior.
